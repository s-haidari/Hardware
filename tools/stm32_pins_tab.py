...
class Stm32PinsWidget(QWidget):
    def __init__(self, parent=None, ctx=None):
        ...
        self.pkg_combo.setToolTip("Choose the STM32 package to view its pinout and switch fabric")
        ...
        self.btn_build.setToolTip("Read the CubeMX pinout and (re)build the pin-authority database")
        ...
        self.btn_gen.setToolTip("Export the pin table and switch fabric to CSV and Markdown")
        ...
        self.rail.add_item("map", "Map").setToolTip("Pin map with the per-pin signal path and source/drain ledger")
        self.rail.add_item("table", "Table").setToolTip("Sortable, filterable table of every pin")
        self.rail.add_item("cells", "Cells").setToolTip("The ADG714 switch cells and their channel assignments")
