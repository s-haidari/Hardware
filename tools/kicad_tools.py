...
class KiCadToolsWidget(QWidget):
    ...
    def __init__(self, parent, projects_dir: str, save_dir_cb=None, ctx=None):
        ...
        self.proj_btn.setToolTip("Pick which projects the tools below act on")
        ...
        hb = QHBoxLayout()
        b_all = QPushButton("All"); b_all.setToolTip("Select every project")
        b_all.clicked.connect(lambda: self._check_all(True))
        b_none = QPushButton("None"); b_none.setToolTip("Clear the project selection")
